...
<p>
Install Active Directory Domain Services on DC-1 and promote it to a domain controller. Add a new forest, then specify the root domain name. "mydomain.com" is used as an example domain.
</p>
